    ...
    <footer id="contact" className="bg-gray-900 text-gray-300 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-3 sm:mb-4">
              ...
              <span className="text-lg sm:text-xl font-bold text-white">{t("nav.title")}</span>
            </div>
          ...
          <div>
            <h3 className="text-white font-semibold mb-3 sm:mb-4 text-base sm:text-lg">{t("footer.quickLinks")}</h3>
          ...
          <div>
            <h3 className="text-white font-semibold mb-3 sm:mb-4 text-base sm:text-lg">{t("footer.contact")}</h3>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 text-center text-gray-400">
          <p className="text-xs sm:text-sm">&copy; {new Date().getFullYear()} LED Display Screen Technical Training. {t("footer.rights")}</p>
        </div>
      </div>
    </footer>
  );
